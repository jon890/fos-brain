...
Phase 02와 03의 공개·보호·웹훅 검증이 모두 통과한 경우에만 hosting.kr에서 권한 네임서버를 Cloudflare 지정값으로 교체한다.
...
공개 호스트의 대표 경로, 보호 호스트의 로그인과 허용 계정 접근, Jenkins 정상·오류 HMAC, `brain`의 public-only 콘텐츠를 외부에서 검사한다.
