...
try {
  ...
  await assertDriver("two-dimensional-viewport-controls", assertions.twoDimensionalViewportControls)
  ...
  await assertDriver("viewport-reset-hidden-in-3d", assertions.viewportResetHiddenInThreeD)
