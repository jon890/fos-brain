---
source: github.com/jon890/nhncloud-cli .github/workflows/claude-code-review.yml
collected: 2026-05-28
type: session-note
---

# AI 코드 리뷰 워크플로우 (GitHub Actions) — 설계 메모

nhncloud-cli(공개 repo) 에 anthropics/claude-code-action 으로 PR 자동 코드 리뷰를 붙이며 정리한 재사용 방법론.
dooray-cli 에서 4 병렬 에이전트 버전을 이식했다가 단일 opus 리뷰어로 전환했다.
...
- 일관성과 단순함을 원하면 단일 opus, 속도와 비용 최적화를 원하면 병렬을 고른다.
